...
REM
REM Generated by Vivado on Sun Apr 30 20:22:54 +0200 2023
...
echo "xvhdl --incr --relax -prj divtb_vhdl.prj"
call xvhdl  --incr --relax -prj divtb_vhdl.prj -log xvhdl.log
